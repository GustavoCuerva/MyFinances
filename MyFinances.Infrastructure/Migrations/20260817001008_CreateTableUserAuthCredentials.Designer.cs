...
namespace MyFinances.Infrastructure.Migrations
{
    ...
    [Migration("20260817001008_CreateTableUserAuthCredentials")]
    partial class CreateTableUserAuthCredentials
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFinances.Application.Common.Database.DbModels.AuthCredentialsDbModel", b =>
                {
                    ...
                    b.ToTable("user_auth_credentials", (string)null);
                });
            ...
            modelBuilder.Entity("MyFinances.Application.Common.Database.DbModels.AuthCredentialsDbModel", b =>
                {
                    b.HasOne("MyFinances.Application.Common.Database.DbModels.UserDbModel", "User")
                        .WithOne("Credentials")
                        .HasForeignKey("MyFinances.Application.Common.Database.DbModels.AuthCredentialsDbModel", "UserId")
